...
func (m *TodoMutation) SetTodoID(i int) {
	m.owner = &i
}

// TodoID returns the value of the "todo_id" field in the mutation.
func (m *TodoMutation) TodoID() (r int, exists bool) {
	v := m.owner
	if v == nil {
		return
	}
...
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldTodoID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TodoMutation) ClearTodoID() {
	m.owner = nil
	m.clearedFields[todo.FieldTodoID] = struct{}{}
}

// TodoIDCleared returns if the "todo_id" field was cleared in this mutation.
func (m *TodoMutation) TodoIDCleared() bool {
	_, ok := m.clearedFields[todo.FieldTodoID]
	return ok
}
...
func (m *TodoMutation) ResetTodoID() {
	m.owner = nil
	delete(m.clearedFields, todo.FieldTodoID)
}
...
func (m *TodoMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(todo.FieldTodoID) {
		fields = append(fields, todo.FieldTodoID)
	}
	return fields
}
