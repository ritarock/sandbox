...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Todo.note":
		if e.complexity.Todo.Note == nil {
			break
		}

		return e.complexity.Todo.Note(childComplexity), true
...
//go:embed "common.graphqls" "mutation.graphqls" "query.graphqls" "todo.graphqls"
...
func (ec *executionContext) fieldContext_Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "note":
				return ec.fieldContext_Todo_note(ctx, field)
			case "completed":
...
func (ec *executionContext) _Todo_note(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Todo_note(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Todo_note(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Todo",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputNewTodo(ctx context.Context, obj interface{}) (model.NewTodo, error) {
	...
	fieldsInOrder := [...]string{"id", "title", "note", "completed", "created_at", "updated_at"}
...
func (ec *executionContext) _Todo(ctx context.Context, sel ast.SelectionSet, obj *model.Todo) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "note":
			...
			out.Values[i] = ec._Todo_note(ctx, field, obj)
