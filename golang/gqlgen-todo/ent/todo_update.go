...
func (tu *TodoUpdate) SetNote(s string) *TodoUpdate {
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Note(); ok {
		_spec.SetField(todo.FieldNote, field.TypeString, value)
	}
...
// SetNote sets the "note" field.
func (tuo *TodoUpdateOne) SetNote(s string) *TodoUpdateOne {
