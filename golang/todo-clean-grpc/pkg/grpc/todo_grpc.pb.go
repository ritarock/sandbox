...
const (
	TodoService_Get_FullMethodName    = "/myapp.TodoService/Get"
	TodoService_Create_FullMethodName = "/myapp.TodoService/Create"
)
...
func (c *todoServiceClient) Get(ctx context.Context, in *TodoRequest, opts ...grpc.CallOption) (*TodoResponse, error) {
...
func (UnimplementedTodoServiceServer) Get(context.Context, *TodoRequest) (*TodoResponse, error) {
